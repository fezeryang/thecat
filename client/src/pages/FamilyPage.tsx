 ...
 * Color: Warm cream #fdf6e3 with bold coral #ff4d6d typography
    ...
    >
      ...
      <div
        style={{
          ...
          zIndex: 20,
          background:
            "linear-gradient(rgba(18, 16, 16, 0) 50%, rgba(0, 0, 0, 0.1) 50%), linear-gradient(90deg, rgba(255, 0, 0, 0.06), rgba(0, 255, 0, 0.02), rgba(0, 0, 255, 0.06))",
        ...
        {[0, 1, 2, 3].map(i => (
          <div
            ...
            style={{
              ...
              borderRadius: "50%",
              background:
                activeSection >= i ? "#ff4d6d" : "rgba(196,168,130,0.4)",
      ...
      >
        ...
        <section
          ...
          style={{ paddingLeft: "55vw" }}
        >
          <div>
            <div className="data-label mb-4" style={{ color: "#c4a882" }}>
              CHRONICLE 001 / FAMILY_CORE
            </div>
            <h1
              style={{
            ...
            <div className="data-label mt-4" style={{ color: "#c4a882" }}>
              ↓ 滚动展开正方体
            </div>
          </div>
        </section>
            ...
            >
              {CATS.map(cat => (
                ...
                >
                  ...
                  />
                  <span style={{ color: cat.colorHex, fontWeight: 700 }}>
                    {cat.cnName}
                  </span>
        ...
        >
          <div className="data-label mb-8" style={{ color: "#c4a882" }}>
            大事记 / FAMILY_TIMELINE
          </div>
          <div style={{ position: "relative", paddingLeft: 32 }}>
            <div
              style={{
                ...
                bottom: 0,
                width: 2,
                background: "linear-gradient(to bottom, #ff4d6d, #c4a882)",
              }}
            />
              ...
              <Link
                ...
                onMouseEnter={e => {
                  ...
                  (e.currentTarget as HTMLElement).style.boxShadow =
                    `0 16px 40px ${cat.colorHex}38`;
                }}
                onMouseLeave={e => {
                  (e.currentTarget as HTMLElement).style.transform =
                    "translateY(0) scale(1)";
                  (e.currentTarget as HTMLElement).style.boxShadow =
                    `0 4px 20px ${cat.colorHex}18`;
                }}
              >
                ...
                >
                  ...
                  <div
                    style={{
                      position: "absolute",
                      inset: 0,
                      background: `linear-gradient(to top, ${cat.colorHex}40, transparent)`,
                    }}
                  />
                </div>
                <div style={{ padding: "18px 20px 20px" }}>
                  ...
                  <div
                    ...
                    style={{ color: cat.colorHex, marginBottom: 4 }}
                  >
                    {cat.name}
                  </div>
                  <div
        ...
        <section className="h-screen flex items-center justify-center">
          <div style={{ textAlign: "center" }}>
            ...
            <div className="data-label" style={{ color: "#c4a882" }}>
              CAMPUS FELINES · 2020 — PRESENT
            </div>
            <Link
              href="/"
              style={{
      ...
      <div
        ...
        style={{
          height: 2,
          background: `linear-gradient(to right, #ff4d6d ${scrollProgress * 100}%, transparent ${scrollProgress * 100}%)`,
          width: "100%",
